...
const ModifyRole: React.FC = () => {
  const navigate = useNavigate();
  return (
    <div className="app__layout-system__modify-role">
      <div className="app__layout-system__modify-role__title">
        Danh sách vai trò
      </div>
      <div className="app__layout-system__modify-role__container">
